...
class LeftProductDetailsScreen extends StatelessWidget {
  final int productIndex;
  LeftProductDetailsScreen({Key? key, required this.productIndex})
      : super(key: key);
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: SmoothPageIndicator(
                                    ...
                                    controller: pageController,
                                    count: myCubit.leftProducts[productIndex]
                                        .images!.length),
                              ),
                              Column(
                                mainAxisAlignment:
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      myCubit.leftProducts[productIndex].name!,
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          '${myCubit.leftProducts[productIndex].price} EGP',
                                          style: TextStyle(
                                              fontSize: 30,
                                          ...
                                          child: MyElevatedButton(
                                              ...
                                              widget: Row(
                                                  ...
                                                  children:  [
                                                    ...
                                                    Text(
                                                      myCubit.cartProducts[myCubit.leftProducts[productIndex].id]==true ? 'Remove' :'Add to cart',
                                                      style: const TextStyle(
                                                          fontSize: 20),
                                                    )
                                                  ]),
                                              function: () {
                                                myCubit.addToCart(myCubit.leftProducts[productIndex].id);
                                              }),
                                        ),
                                      ],
                                    ),
                              ...
                              Padding(
                                ...
                                child: Text(
                                  myCubit
                                      .leftProducts[productIndex].description!,
